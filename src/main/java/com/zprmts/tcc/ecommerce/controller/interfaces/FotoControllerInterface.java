...
public interface FotoControllerInterface {
    ...
    @Operation(summary = "Cadastrar uma foto a um perfume", description = "Cadastra uma nova foto no banco de dados e vincula ao Perfume, formatos suportados: WEBP, JPG, JPEG, GIF, PNG, BMP")
    @ApiResponses(
            value = {
    ...
    @PostMapping
    ResponseEntity<FotoDTO> createFotoPerfume(@PathVariable("idPerfume") Long idPerfume,
